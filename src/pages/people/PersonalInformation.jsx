...
const People = () => {
  ...
  const [columnDefs, setColumnDefs] = useState([
    { field: 'placa', filter: true, headerName: "Nombre" },
    { field: 'model', filter: true, headerName: "Apellido" },
    { field: 'model', filter: true, headerName: "Dni" },
    { field: 'model', filter: true, headerName: "Edad" },
    { field: 'model', filter: true, headerName: "Celular" },
    { field: 'model', filter: true, headerName: "Telefono de casa" },
    { field: 'model', filter: true, headerName: "Email" },
    { field: 'model', filter: true, headerName: "Dirección" },
    { field: 'model', filter: true, headerName: "Seguro medico" },
    { field: 'model', filter: true, headerName: "Seguro de vida" },
  ]);
              ...
              <nav>
                <ul className="flex m-0 items-center p-0">
                  <li className="text-left">
                    <a title="" className="cursor-pointer text-gray-400 hover:text-gray-900">
                      <svg className="block h-5 w-5 align-middle" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                      </svg>
                    </a>
                  </li>
                  <li className="flex items-center text-left">
                    <svg className="block h-5 w-5 align-middle text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                      <path d="M5.555 17.776l8-16 .894.448-8 16-.894-.448z"></path>
                    </svg>
                    <Link to="/units" title="" className="cursor-pointer text-sm font-semibold leading-5 text-gray-400 hover:text-gray-900">Datos personales</Link>
                  </li>
                </ul>
              </nav>
              <div className="flex justify-between items-center">
                <p className="mt-5 text-lg font-semibold leading-7 text-solgas-primary">Datos personales</p>
                <button onClick={showAddPersonalInformationModal} className="focus:ring outline-none rounded-lg text-white bg-solgas-primary px-8 py-2 font-semibold active:scale-95 hover:opacity-90 flex gap-2 items-center">
                  Agregar Datos Personales <PlusCircleIcon className="w-6 h-6" />
                </button>
              </div>
            </div>
          </div>
